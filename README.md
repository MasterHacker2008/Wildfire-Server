...
**Small FastAPI app that collects sensor data and predicts wildfire risk.** 🔧
...
- The server allows CORS from anywhere (configured with `allow_origins=['*']`) — this is convenient for development but consider restricting it for production.
